...
class EulerAncestralDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    def step(
        ...
        gen_device = generator.device.type if generator else device
        if device.type == "mps":
            ...
            noise = torch.randn(model_output.shape, dtype=model_output.dtype, device=gen_device, generator=generator).to(
                device
            )
